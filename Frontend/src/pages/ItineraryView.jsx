...
const Itinerary = () => {
  ...
  const payWithStripe = async () => {
    ...
    checkoutWithStripe(id, itinerary, stripeID, "itinerary");
  };
                      ...
                      return (
                        ...
                        >
                          <button
                            ...
                            className={`border py-2 px-3 min-h-20 w-24 rounded-md bg-gradient-to-br from-primary-700/80 to-primary-900/80 text-center ${
                              selectedDate === idx
                  ...
                  {!applied ? (
                    <div className="grid grid-cols-3 w-full max-w-sm items-center gap-1">
                      <div className="col-span-2 p-2">
                        <Label className="text-sm p-1" htmlFor="code">
                          Enter Promocode
                        </Label>
                        <Input
                          type="text"
