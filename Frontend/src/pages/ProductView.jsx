      ...
      <div className="flex justify-between gap-32 py-6">
        <div className="flex flex-col w-full justify-between">
          <div className="flex flex-col gap-6 w-full">
                  ...
                  <>
                    <span>
                      ...
                      <a
                        ...
                        onClick={() =>
                          navigate(`/app/profile/${product.creatorId?._id}`)
                        }
                      >
            ...
            {(product.creatorId?._id === id ||
              (role === "admin" && product.creatorId === null)) && (
          ...
          <div className="flex items-center gap-4">
            <Button onClick={() => handleBuyProduct()} className="flex-grow">
        ...
        <div className="h-[400px] w-[400px] shrink-0">
          <Carousel>
            <CarouselContent>
              {product.cardImage && product.cardImage.url ? (
