...
const site = {
    ...
    description: "Nestled atop a rugged hill, this ancient fortress once guarded a thriving medieval town.Its crumbling stone walls and towering arches whisper stories of battles fought and lives lived centuries ago. Today, the site offers breathtaking views of the surrounding valley, transporting visitors back in time.",
    imageUris: [
                    ...
                    <div className=" bg-primary-700 rounded-lg col-span-1">
                        {Object.keys(site.ticketPrices).length === 0? (
                            ...
                            <div className=" flex flex-col justify-center items-center h-full w-ful rounded-lg">
                                ...
                                <p className=" text-2xl font-semibold self-center text-primary-950">No available bookings</p>
                            </div>
                        ):(
                                <div className="w-full h-full justify-around">
                                    {Object.entries(site.ticketPrices).map(([type, price]) => (
                                        <div key={type} className="flex flex-col justify-between bg-primary-900 border rounded-lg p-4 m-4">
                                            ...
                                            {price === 0 ? (
                                                ...
                                                <>
                                                <span className="text-xl px-1 font-semibold">{price}</span>
