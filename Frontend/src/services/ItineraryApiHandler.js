...
export const bookItinerary = async (itineraryId, userId, date, adultTicketCount, childTicketCount) => {
    try {
        ...
        return { message: "Failed to book itinerary", error: error.message };
    }
};

export const addItineraryComment = async (itineraryId, commentData) => {
    try {
        const response = await axiosInstance.post(`/itinerary/${itineraryId}/comment`, commentData);
        return response.data;
    } catch (error) {
        return error;
    }
...
export const addItineraryRating = async (itineraryId, ratingData) => {
    try {
        const response = await axiosInstance.post(`/itinerary/${itineraryId}`, ratingData);
        return response.data;
    } catch (error) {
        return error;
    }
