...
const updateTourist = async (req, res) => {
    ...
    if (tourist.profileImageUri && tourist.profileImageUri.public_id && req.files.profileImageUri) {
        await cloudinary.uploader.destroy(tourist.profileImageUri.public_id);
    }

    if (tourist.bannerImageUri && tourist.bannerImageUri.public_id && req.files.bannerImageUri) {
